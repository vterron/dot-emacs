;; Theme configuration file (GNU Emacs)
;; -----------------------------------
;;  Author: Víctor Terrón
;;  Time-stamp: <2012-03-29 17:06:19 vterron>

(require 'color-theme)
(require 'manoj-colors)

;; Inherited from Juan Pedro Bolívar (raskolnikov)
...
(set-face-background 'mode-line "#600000")
(set-face-foreground 'mode-line "#eeeeee")
(set-face-foreground 'minibuffer-prompt "#cc0000")

(provide 'vterron-theme)